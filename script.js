...
function changeBrightness(factor, sprite) {
  ...
  var imgData = context.getImageData(0, 0, virtCanvas.width, virtCanvas.height);
...
window.onload = function () {
  ...
  sprite = new Image();
  sprite.src = "images/mouse.png" + "?" + new Date().getTime();
  ...
  finishSprite.src = "images/cheese.png" + "?" + new Date().getTime();
